...
function updateFilters() {
    ...
    let changedValue = changedElements.property("value");
    console.log(changedValue);

    // 4c. Save the id of the filter that was changed as a variable.
    let changedID = changedElements.attr("id");
  ...
  function filterTable() {
    ...
    for (var r = 0; r < filters.length; r++) {
        filteredData = filteredData.filter(row => row.Object.keys(filters[r]) == Object.values(filters[r]));
    };
